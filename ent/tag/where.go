...
func ParentID(v int) predicate.Tag {
	return predicate.Tag(func(s *sql.Selector) {
...
func ParentIDEQ(v int) predicate.Tag {
	return predicate.Tag(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldParentID), v))
	})
}
...
func ParentIDNEQ(v int) predicate.Tag {
	return predicate.Tag(func(s *sql.Selector) {
...
func ParentIDIn(vs ...int) predicate.Tag {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ParentIDNotIn(vs ...int) predicate.Tag {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
